...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_a058_d968_f7e2_ced1_a693_bdf4_4786_b7d2',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ᴊᴀʀᴠɪꜱ',
  ...
  SUDO: process.env.SUDO || '2247032983433,
